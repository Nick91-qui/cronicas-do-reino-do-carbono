...
> = {
  login: {
    ...
    description:
      "Informe seu nome de oficio e sua chave sigilosa para retomar os estudos alquimicos.",
    ...
    <section className="game-shell grid gap-4 lg:grid-cols-[1.02fr,0.98fr]">
      <div className="grid gap-4">
        <article className="game-panel border-cyan-300/15">
          ...
          <h1
            className={`pt-4 tracking-[0.06em] text-white ${
              mode === "login" ? "text-3xl sm:text-4xl" : "text-4xl sm:text-5xl"
            }`}
          >
      ...
      <div className="game-panel p-4 shadow-2xl shadow-black/20 sm:p-8">
        ...
        <h1 className="mt-3 text-2xl tracking-[0.05em] text-white sm:text-3xl">
